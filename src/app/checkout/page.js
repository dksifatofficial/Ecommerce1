...
//                   <p>PostalCode : {item.postalCode}</p>
//                   <button
//                     className="mt-5 mr-5 inline-block bg-black text-white px-5 
//                   py-3 text-xs font-medium uppercase tracking-wide"
//                   >
//                     {item._id === selectedAddress
//                       ? "Selected Address"
//                       : "Select Address"}
...
//                 }
//                 onClick={handleCheckout}
//                 className="disabled:opacity-50 mt-5 mr-5 w-full  inline-block bg-black text-white 
