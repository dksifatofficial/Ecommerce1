  ...
  return (
    <>
      <div className=" flex justify-center w-full">
        <div className="pt-6 grid lg:flex justify-items-center w-[100%] px-[100px] bg-[#f85606]">
          <div
          ...
          >
            ...
            <p
              className="w-full text-center font-serif tracking-[1px] text-white py-4
          ...
          <div className="w-full lg:w-[60%] flex justify-around lg:justify-around mt-6 lg:mt-0">
            ...
            <div className="h-[120px] grid justify-center w-[20%]">
              ...
              >
                ...
                <p className="text-white text-[14px]">Linkedin</p>
              </Link>
            </div>
            ...
            <div className="h-[120px] pt-2 grid justify-center w-[20%]">
              <Link
                className="text-white text-[14px] font-semibold pt-0"
                href="/disclaimer"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="w-full flex justify-center bg-[#f85606]">
        <p className="px-4 lg:px-0 tracking-[1px] text-[12px] text-white text-center pt-4 pb-8 lg:w-[90%] lg:text-left">
          <Link
